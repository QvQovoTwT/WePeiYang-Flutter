...
class _PrivateChatConversationPageState
  ...
  void initState() {
    ...
    // 进入聊天页面，设置当前联系人并加载聊天记录
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final provider = context.read<PrivateChatProvider>();
      provider.selectContact(widget.contact);
    });
  }
  ...
  void dispose() {
    ...
    _focusNode.dispose();
    // 退出聊天页面时清理当前联系人
    context.read<PrivateChatProvider>().clearCurrentContact();
    super.dispose();
  }
  ...
  void _showBlockConfirmDialog(
      BuildContext context, PrivateChatProvider provider, bool isBlocked) {
    showDialog(
      context: context,
      builder: (c) => AlertDialog(
        title: Text(isBlocked ? '解除拉黑' : '拉黑用户',
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text('复制',
                    style: TextUtil.base.regular.sp(15).label(context)),
                onTap: () {
                  Navigator.pop(ctx);
              ...
              ListTile(
                ...
                title: Text('删除',
                    style: TextUtil.base.regular.sp(15).copyWith(
                        color: WpyTheme.of(context)
                            .get(WpyColorKey.dangerousRed))),
                subtitle: Text('仅从你的记录中删除',
                    style: TextUtil.base.regular.sp(11).secondary(context)),
                onTap: () async {
                  Navigator.pop(ctx);
                  ...
                  child: provider.currentMessages.isEmpty
                      ...
                      : Builder(builder: (context) {
                          ...
                          final displayMessages =
                              provider.currentMessages.reversed.toList();
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final isMine = msg.senderId == provider.myUserId;
                              final showTime =
                                  _shouldShowTime(displayMessages, index);
...
class _ChatBubble extends StatelessWidget {
  ...
  const _ChatBubble(
      {required this.msg, required this.isMine, this.onLongPress});
